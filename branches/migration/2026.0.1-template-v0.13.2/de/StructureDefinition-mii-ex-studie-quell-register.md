...
| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/modul-studie/StructureDefinition/mii-ex-studie-quell-register | *Version*:2026.0.1 |
| Active Stand: 2026-08-31 | *Maschinenlesbarer Name*:MII_EX_Studie_Quell_Register |
...
Weitere Repräsentationen des Profils: [CSV](../StructureDefinition-mii-ex-studie-quell-register.csv), [Excel](../StructureDefinition-mii-ex-studie-quell-register.xlsx), [Schematron](../StructureDefinition-mii-ex-studie-quell-register.sch) 
