...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Library">
      <sch:assert test="count(f:extension[@url = 'https://www.medizininformatik-initiative.de/fhir/modul-studie/StructureDefinition/mii-ex-studie-quell-register']) &lt;= 1">extension with URL = 'https://www.medizininformatik-initiative.de/fhir/modul-studie/StructureDefinition/mii-ex-studie-quell-register': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Library/f:relatedArtifact">
      ...
      <sch:assert test="count(f:document) &gt;= 1">document: minimum cardinality of 'document' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:Library/f:relatedArtifact/f:document</sch:title>
