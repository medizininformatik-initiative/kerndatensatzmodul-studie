# Security and Privacy - MII Implementation Guide Medizinisches Forschungsvorhaben v2027.0.0-ballot.rc1
...
Beyond the overarching framework linked above — the overarching data protection concept, the Broad Consent it rests on, and DIMP — this module carries no data category that raises security or privacy aspects of its own, and it places no module-specific security or privacy requirements on implementers.
