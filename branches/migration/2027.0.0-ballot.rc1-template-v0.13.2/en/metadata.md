# Metadata Overview - MII Implementation Guide Medizinisches Forschungsvorhaben v2027.0.0-ballot.rc1
...
This page documents the computable metadata of the **Medizinisches Forschungsvorhaben** module. The metadata exists so that the artifacts of this guide can be discovered, evaluated, validated, cited, governed and reused — by people and by software alike.
...
| [Resource Approval Date](http://hl7.org/fhir/extensions/5.3.0/StructureDefinition-resource-approvalDate.html) | Artifact lifecycle; publishing; governance | `ImplementationGuide.extension`(`2026-01-09`) | Records the date on which the publisher officially approved the content for use. |
...
| | | | |
| :--- | :--- | :--- | :--- |
| F1 | RDA-F1-01M | Metadata is identified by a persistent identifier | Canonical`url`values, the package id`de.medizininformatikinitiative.kerndatensatz.studie`, the package version and`package-source`. Persistence depends on publication governance. |
