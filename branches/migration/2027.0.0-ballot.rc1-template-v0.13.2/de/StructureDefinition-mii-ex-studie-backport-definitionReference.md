# MII EX Studie Backport definitionReference - MII Implementation Guide Medizinisches Forschungsvorhaben v2027.0.0-ballot.rc1

* [**Table of Contents**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **MII EX Studie Backport definitionReference**

## Extension: MII EX Studie Backport definitionReference 

| | |
| :--- | :--- |
| *Offizielle URL*:http://hl7.org/fhir/5.0/StructureDefinition/extension-EvidenceVariable.characteristic.definitionReference | *Version*:2027.0.0-ballot.rc1 |
| Active Stand: 2026-09-11 | *Maschinenlesbarer Name*:MII_EX_Studie_Backport_definitionReference |

R5-Backport des Elements definitionReference für EvidenceVariable.characteristic in FHIR R4.
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/de.medizininformatikinitiative.kerndatensatz.studie|current/StructureDefinition/StructureDefinition-mii-ex-studie-backport-definitionReference.json)
...
Simple Extension with the type Reference: R5-Backport des Elements definitionReference für EvidenceVariable.characteristic in FHIR R4.
...
Weitere Repräsentationen des Profils: [CSV](../StructureDefinition-mii-ex-studie-backport-definitionReference.csv), [Excel](../StructureDefinition-mii-ex-studie-backport-definitionReference.xlsx), [Schematron](../StructureDefinition-mii-ex-studie-backport-definitionReference.sch) 
...
```json
{
  ...
  "name" : "MII_EX_Studie_Backport_definitionReference",
  ...
  "_description" : {
    "extension" : [{
      ...
      {
        "url" : "content",
        "valueString" : "R5-Backport des Elements definitionReference für EvidenceVariable.characteristic in FHIR R4."
      }],
    ...
    },
    {
      ...
      {
        "url" : "content",
        "valueString" : "R5 backport of the definitionReference element for EvidenceVariable.characteristic in FHIR R4."
      }],
      "url" : "http://hl7.org/fhir/StructureDefinition/translation"
    }]
  },
