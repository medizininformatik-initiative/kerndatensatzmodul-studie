...
| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/modul-studie/StructureDefinition/mii-ex-studie-eligibility | *Version*:2027.0.0-ballot |
| Active Stand: 2026-01-09 | *Maschinenlesbarer Name*:MII_EX_Studie_Eligibility |

Extension zur Referenzierung der Ein- und Ausschlusskriterien des Forschungsvorhabens.
...
Simple Extension with the type Reference: Extension zur Referenzierung der Ein- und Ausschlusskriterien des Forschungsvorhabens.
...
```json
{
  ...
  "_description" : {
    "extension" : [{
      ...
      {
        "url" : "content",
        "valueString" : "Extension zur Referenzierung der Ein- und Ausschlusskriterien des Forschungsvorhabens."
      }],
    ...
    },
    {
      ...
      {
        "url" : "content",
        "valueString" : "Extension referencing the eligibility criteria of the research study."
      }],
      "url" : "http://hl7.org/fhir/StructureDefinition/translation"
    }]
  },
