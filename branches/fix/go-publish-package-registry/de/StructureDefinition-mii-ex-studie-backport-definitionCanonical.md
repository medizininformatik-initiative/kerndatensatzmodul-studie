# MII EX Studie Backport definitionCanonical - MII Implementation Guide Medizinisches Forschungsvorhaben v2027.0.0-ballot
...
| | |
| :--- | :--- |
| *Offizielle URL*:http://hl7.org/fhir/5.0/StructureDefinition/extension-EvidenceVariable.characteristic.definitionCanonical | *Version*:2027.0.0-ballot |
| Active Stand: 2026-01-09 | *Maschinenlesbarer Name*:MII_EX_Studie_Backport_definitionCanonical |

R5-Backport des Elements definitionCanonical für EvidenceVariable.characteristic in FHIR R4.
...
Simple Extension with the type canonical: R5-Backport des Elements definitionCanonical für EvidenceVariable.characteristic in FHIR R4.
...
```json
{
  ...
  "_description" : {
    "extension" : [{
      ...
      {
        "url" : "content",
        "valueString" : "R5-Backport des Elements definitionCanonical für EvidenceVariable.characteristic in FHIR R4."
      }],
    ...
    },
    {
      ...
      {
        "url" : "content",
        "valueString" : "R5 backport of the definitionCanonical element for EvidenceVariable.characteristic in FHIR R4."
      }],
      "url" : "http://hl7.org/fhir/StructureDefinition/translation"
    }]
  },
