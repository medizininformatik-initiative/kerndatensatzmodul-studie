# MII EX Studie Backport linkId - MII Implementation Guide Medizinisches Forschungsvorhaben v2027.0.0-ballot
...
| | |
| :--- | :--- |
| *Official URL*:http://hl7.org/fhir/5.0/StructureDefinition/extension-EvidenceVariable.characteristic.linkId | *Version*:2027.0.0-ballot |
| Active as of 2026-01-09 | *Computable Name*:MII_EX_Studie_Backport_linkId |

R5 backport of the linkId element for EvidenceVariable.characteristic in FHIR R4.
...
Other representations of profile: [CSV](../StructureDefinition-mii-ex-studie-backport-linkId.csv), [Excel](../StructureDefinition-mii-ex-studie-backport-linkId.xlsx), [Schematron](../StructureDefinition-mii-ex-studie-backport-linkId.sch) 
