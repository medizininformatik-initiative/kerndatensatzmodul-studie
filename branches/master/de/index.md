...
Die vorliegende Spezifikation beschreibt die FHIR-Repräsentation des Kerndatensatz Moduls Medizinisches Forschungsvorhaben der Medizininformatik-Initiative. Im Folgenden werden die Use-Case des Moduls sowie die dazugehörigen FHIR-Profile und Terminologie-Ressourcen in ihrer verbindlichen Form beschrieben.

| | |
| :--- | :--- |
| Datum | 2026-09-14 |
| Version | 2027.0.0-ballot (CalVer`JJJJ.n.n`, Ballot) |
| Status | active |
| Realm | DE |
