...
// ─────────────────────────────────────────────────────────────────────────────
// Template-scaffold aliases appended by the migration (mii-kds-module-template
// v0.13.2 input/fsh/aliases.fsh) — per-DEFINITION merge, module definitions win:
// skipped as already defined by the module: $v2-0203, $identifier-type-de-basis.
// ─────────────────────────────────────────────────────────────────────────────
