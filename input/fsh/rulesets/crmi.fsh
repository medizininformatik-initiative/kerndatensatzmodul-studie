...
// Author = the module author (office@medizininformatik-initiative.de). Editor / reviewer /
...
* ^extension[=].valueContactDetail.telecom[=].value = "office@medizininformatik-initiative.de"
