...
| `studie` | `version.fsh` (package id + canonical of the package source) |
...
| `2026-01-09` | passed in at the call site: `insert CRMIApprovalDate(2026-01-09)` |
| `C15206` | passed in at the call site: `insert CRMIArtifactTopic(…, C15206)` |
