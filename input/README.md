...
| `pagecontent/` | The IG's narrative pages as Markdown (`index.md`, `guidance.md`, …). Every page listed under `pages:` in `sushi-config.yaml` needs a file here. **German is the default content language** (DE-first); the English mirror lives in `translations/en/pagecontent/`. | IG Publisher |
...
| `translations/` | Translation supplements. This module is **German-default with English mirrors** under `translations/en/` (DE-first) — see `translations/README.md`. | IG Publisher (i18n) |
