...
This page lists the FHIR profiles of the **Medizinisches Forschungsvorhaben** module. As a
...
[`docs/recipes/add-a-profile.md`](https://github.com/forschungsgruppe-digital-health/mii-kds-studie-ig-inoffiziell/blob/main/docs/recipes/add-a-profile.md) in this repository, and the MII naming
