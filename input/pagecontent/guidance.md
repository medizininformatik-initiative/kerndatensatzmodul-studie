...
Moduls **Medizinisches Forschungsvorhaben**.
...
* **[Datensätze und Beschreibungen](logical-models.html)** — die Datenelemente
  ...
  [`docs/page-structure.md`](https://github.com/forschungsgruppe-digital-health/mii-kds-studie-ig-inoffiziell/blob/main/docs/page-structure.md) in diesem Repository.)
...
<!-- Migrated 2026-08-31 from ImplementationGuide-2027.x.x-DE/MIIIGModulStudie/AnwendungsflleInformationsmodell/BeschreibungvonSzenarienfrdieAnwendungderModule.page.md (verbatim transfer per
