...
Diese Seite listet die FHIR-Profile des Moduls **Medizinisches Forschungsvorhaben**. Als
...
[`docs/recipes/add-a-profile.md`](https://github.com/forschungsgruppe-digital-health/mii-kds-studie-ig-inoffiziell/blob/main/docs/recipes/add-a-profile.md) in diesem Repository sowie die
