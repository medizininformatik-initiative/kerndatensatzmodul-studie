# MII EX Studie Backport DefinitionByTypeAndValue - MII Implementation Guide Medizinisches Forschungsvorhaben v2027.0.0-ballot
...
| | |
| :--- | :--- |
| *Official URL*:http://hl7.org/fhir/5.0/StructureDefinition/extension-EvidenceVariable.characteristic.definitionByTypeAndValue | *Version*:2027.0.0-ballot |
| Active as of 2026-01-09 | *Computable Name*:MII_EX_Studie_Backport_Definition_By_Type_And_Value |

R5 backport of the definitionByTypeAndValue element for EvidenceVariable.characteristic in FHIR R4.
...
Other representations of profile: [CSV](../StructureDefinition-mii-ex-studie-backport-definition-by-type-and-value.csv), [Excel](../StructureDefinition-mii-ex-studie-backport-definition-by-type-and-value.xlsx), [Schematron](../StructureDefinition-mii-ex-studie-backport-definition-by-type-and-value.sch) 
