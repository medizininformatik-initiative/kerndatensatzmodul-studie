# MII EX Studie Akronym - MII Implementation Guide Medizinisches Forschungsvorhaben v2027.0.0-ballot
...
| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/modul-studie/StructureDefinition/mii-ex-studie-akronym | *Version*:2027.0.0-ballot |
| Active Stand: 2026-01-09 | *Maschinenlesbarer Name*:MII_EX_Studie_Akronym |

Extension zur Angabe des Akronyms eines Forschungsvorhabens.
...
Simple Extension with the type string: Extension zur Angabe des Akronyms eines Forschungsvorhabens.
...
Weitere Repräsentationen des Profils: [CSV](../StructureDefinition-mii-ex-studie-akronym.csv), [Excel](../StructureDefinition-mii-ex-studie-akronym.xlsx), [Schematron](../StructureDefinition-mii-ex-studie-akronym.sch) 
...
```json
{
  ...
  "_description" : {
    "extension" : [{
      ...
      {
        "url" : "content",
        "valueString" : "Extension zur Angabe des Akronyms eines Forschungsvorhabens."
      }],
    ...
    },
    {
      ...
      {
        "url" : "content",
        "valueString" : "Extension for the acronym of a research study."
      }],
      "url" : "http://hl7.org/fhir/StructureDefinition/translation"
    }]
  },
